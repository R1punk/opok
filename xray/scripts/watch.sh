...
echo "" > /data/data/com.termux/files/home/.suroot/xray/run/lastmobile
echo "" > /data/data/com.termux/files/home/.suroot/xray/run/lastwifi
...
main(){
    ...
    if test ! -z "${wifistatus}" ; then
        echo "" > /data/data/com.termux/files/home/.suroot/xray/run/lastmobile
        if test ! "${wifistatus}" = "$(cat /data/data/com.termux/files/home/.suroot/xray/run/lastwifi)" ; then
            change=$((${change} + 1))
            echo "${wifistatus}" > /data/data/com.termux/files/home/.suroot/xray/run/lastwifi
    ...
    if test "${mobilestatus}" -ne 0 ; then
        if test ! "${mobilestatus}" = "$(cat /data/data/com.termux/files/home/.suroot/xray/run/lastmobile)" ; then
            change=$((${change} + 1))
            echo "${mobilestatus}" > /data/data/com.termux/files/home/.suroot/xray/run/lastmobile
        fi
    fi
...
default(){
    /data/data/com.termux/files/usr/bin/busybox crond -c /data/data/com.termux/files/home/.suroot/xray/run/

    touch /data/data/com.termux/files/home/.suroot/xray/run/root
    chmod 0600 /data/data/com.termux/files/home/.suroot/xray/run/root
    chown 0:0 /data/data/com.termux/files/home/.suroot/xray/run/root

    echo "* * * * * ${scripts_dir}/cron.sh" > /data/data/com.termux/files/home/.suroot/xray/run/root
}

stop(){
    cronexe=$(ps -ef | grep root | grep "crond -c /data/data/com.termux/files/home/.suroot/xray/" | awk '{ print $2 }')
